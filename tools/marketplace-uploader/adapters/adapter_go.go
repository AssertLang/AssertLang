...
func capabilities() map[string]any { return map[string]any{"tool": "marketplace-uploader", "versions": []string{"v1"}, "features": []string{"validation","envelope","idempotency"}} }
