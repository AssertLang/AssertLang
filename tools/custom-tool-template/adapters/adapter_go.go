...
func capabilities() map[string]any { return map[string]any{"tool": "custom-tool-template", "versions": []string{"v1"}, "features": []string{"validation","envelope","idempotency"}} }
