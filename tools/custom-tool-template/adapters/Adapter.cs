...
public static class Adapter {
  public static Dictionary<string,object> Capabilities(){ return new Dictionary<string,object>{ {"tool", "custom-tool-template"}, {"versions", new List<string>{"v1"}}, {"features", new List<string>{"validation","envelope","idempotency"}} }; }
