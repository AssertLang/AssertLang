...
public class Adapter {
  public static Map<String,Object> capabilities(){ Map<String,Object> m=new HashMap<>(); m.put("tool", "firewall"); m.put("versions", Arrays.asList("v1")); m.put("features", Arrays.asList("validation","envelope","idempotency")); return m; }
