...
public static class Adapter {
  public static Dictionary<string,object> Capabilities(){ return new Dictionary<string,object>{ {"tool", "thread"}, {"versions", new List<string>{"v1"}}, {"features", new List<string>{"validation","envelope","idempotency"}} }; }
