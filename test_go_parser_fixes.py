...
# Save to file
with open("/Users/hustlermain/HUSTLER_CONTENT/HSTLR/DEV/Promptware/test_go_parser_fixes_output.pw", "w") as f:
    f.write(pw_dsl)

print(f"\n✅ Saved to test_go_parser_fixes_output.pw ({len(lines)} lines)")
